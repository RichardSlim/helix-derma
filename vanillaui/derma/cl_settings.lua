...
function PANEL:PerformLayout(width, height)
	surface.SetFont("cwMenuButtonFont")
...
function PANEL:Init()
	...
	self.textEntry:SetFont("cwMenuButtonFont")
...
function PANEL:Init()
	...
	self.setting:Dock(RIGHT)
	self.setting:SetFont("cwMenuButtonFont")
...
function PANEL:Init()
	...
	self.text:Dock(LEFT)
	self.text:SetFont("cwMenuButtonFont")
...
function PANEL:SetShowReset(value, name, default)
	...
	if (value and !IsValid(self.reset)) then
		...
		self.reset:SetFont("cwMenuButtonFont")
