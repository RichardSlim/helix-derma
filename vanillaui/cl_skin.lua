...
local clockworkGradient = Material("clockwork/screendamage.png")
local clockworkGradient2 = Material("clockwork/screendamage2.png")
local clockworkVignette = Material("clockwork/vignette.png")
local clockworkMenu = Material("clockwork/sliced/simpletint.png")
...
function SKIN:PaintCategoryPanel(panel, text, color)
	...
	surface.SetFont("cwAuthorFont")

	local textHeight = select(2, surface.GetTextSize(text)) - 4
	local width, height = panel:GetSize()
...
function SKIN:PaintChatboxBackground(panel, width, height)
	...
	if (panel:GetActive()) then
		surface.SetDrawColor(40, 40, 40, 255)
		surface.SetMaterial(clockworkVignette)
...
function SKIN:PaintInfoBar(panel, width, height, color)
	...
	-- gradient overlay
	surface.SetDrawColor(170, 170, 170, 180)
	surface.SetMaterial(clockworkGradient2)
	surface.DrawTexturedRect(0, 0, width, height)
end

function SKIN:PaintInfoBarBackground(panel, width, height)
	surface.SetDrawColor(230, 230, 230, 105)
	surface.SetMaterial(clockworkGradient2)
	surface.DrawRect(0, 0, width, height)
	surface.DrawTexturedRect(0, 0, width, height)
	surface.SetDrawColor(120, 120, 120, 125)
	surface.DrawOutlinedRect(0, 0, width, height)
